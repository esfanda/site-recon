...
- **Tunnel type:** Quick Tunnel first (`deploy/site-recon-demo-tunnel-quick.service`). Named Tunnel for `site-recon.erfandigital.com` when Cloudflare zone + `~/.cloudflared/cert.pem` are ready — see `docs/Named Tunnel Setup.md`.
